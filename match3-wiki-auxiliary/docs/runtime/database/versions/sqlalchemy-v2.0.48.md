...
> See [`../protocol.md`](../protocol.md) for the `DatabaseEngine` / `DatabaseSession` protocols and [`../implementation.md`](../implementation.md) for the `PostgreSQLEngine` / `PostgreSQLSession` adapters.
